...
\citep{raichle2005intrinsic}. This paper proposes a formal model that satisfies this contention.
...
\begin{itemize}
  ...
  %
  As such, our account can be viewed as a RL implemnetion of the
