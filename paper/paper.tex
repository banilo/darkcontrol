...
\begin{itemize}
  ...
  \item Also, note that the wake-sleep algorithm doesn't do backprop! This is due to
    echnical difficulty in getting derivatives of loss function w.r.t
    recognition wieghts $\W^R$).
  \item This difficulty was removed in the 2010s by Kingma et al., an other groups, via some kind of ``reparametrization trick''.
