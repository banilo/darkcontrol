...
can be experienced, hypothetically imagined, or simply future expectations.
Formally, we propose reinforcement learning as a particularly attractive framework
for describing and quantifying the DMN function.
...
reward evaluation~\citep{carlezon2009,haber1995,croxson2005quantitative}.
...
$Q$-value function. This warrants a learning process and definition of a loss
...
specific prior actions and environmental states. The HC is a strong candidate
