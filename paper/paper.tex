...
reward and the discounted rewards of the upcoming states in the environment.
...
defined learning goal -- the \textit{loss function}.
...
and is recorded in replay memory buffer -- which we hypothesize to be the
...
Reward prediction errors -- also known as \textit{regret}-- percolate
...
both of which are incorporated into MDPs.
...
cognitive account that was proposed for DMN function \citep{gusnard2001medial}.
Since then,
