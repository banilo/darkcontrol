...
\begin{figure}[!h]
  ...
  The blue horizontal line indicates the cytoarchitectonic border between the
  more dorsal BA9 and the more ventral BA10 (Brodmann, 1909).
  %
...
with the HC \citep{henceforth implying to include also parahippocampal regions}
