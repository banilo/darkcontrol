...
\label{sec:vae}
Here, we present a possible way to aleviate some conceptual and computational issues with the
...
\item It is difficult to compute with the free energy principle
 ...
 \ref{sec:vae} can help to remove these barriers.
  \end{itemize}


\subsection{Control theory}
\begin{itemize}
  \item Cite stuff from Bert K.
