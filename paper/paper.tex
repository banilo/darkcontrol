...
In the DMN, the dmPFC (BA9) would implement such a greedy (i.e., heuristic but efficient) lookup
...
The model
  ...
  The oracle Q-values $Q(s, a|\theta)$ tell the DMN the (expected) usefulness of taking an action a in state $s$.
