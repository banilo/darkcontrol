...
is linked to the reward circuitry (Fig. \ref{fig:dmn}),
...
is the time-discounted cumulative reward% function
\begin{equation}
  \label{eq:cumr}
...
may extent to several parts of the DMN \citep{behrens_grid} (see
...
performing action on the environment (Fig. \ref{fig:VennDiagram}).
...
explicit world knowledge (i.e., semantics, Fig. \ref{fig:VennDiagram})
