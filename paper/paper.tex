...
% \textit{greedy policy}
\subsubsection{Optimal behavior and the Bellman temporal consistency}
...
local minimal of differentiable functions. Stochastic here that the true gradient is estimated from batches of training examples samples from the replay memory, the HC
