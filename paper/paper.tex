...
The ventromedial prefrontal DMN (\textbf{XXX Elvis: you mean ``... ventromedial prefrontal part of the DMN'' ?}) may
...
\citep{ng2004,abbeel2004}, super-human play in complex games like Atari\citep{mnih2015} and Go\citep{silver2016mastering}, etc., just to name a few.
...
\begin{equation}
  \begin{split}
   ...
   &= \text{instantaneous reward} + \text{expected maximum reward thereafter}
