...
\begin{itemize}
  ...
  are here directly related to the advantages of stochastic optimization.
...
might implement supra-modal control of the environment to
...
approach to DMN function is not only practically computable but
...
to constantly improve sensory input and peformed action in the world.
