...
and strategic board games \citep{silver2016mastering}.
...
and tracking all possible states and actions may require excessive
...
$Q$-values.
It is this mapping from states to actions that is conventionally called
policy matrix \citep{mnih2015,silver2016mastering}.
...
This becomes possible by recasting the reward signal maximized by the DMN to 
...
\begin{equation}
  r^{\text{FEP}} = \underbrace{\log (p_G)}_{-\text{FEP generative surprise}}.
    \end{equation}
...
may be insufficient to explain
the diversity of behaviors observed in humans and other intelligent animals.
