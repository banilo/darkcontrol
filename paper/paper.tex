...
morphological variability in DMN nodes
...
\begin{figure}[!h]
  \includegraphics[width=.9\linewidth]{VennDiagram-2017-09-08.pdf}
...
by using a reparametrization maneuver. For instance, unlike the wake-sleep algorithm
