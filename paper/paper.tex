...
There a number of common properties between the predictive coding account
and the proposed formal account.
Both frameworks are plausibilized by neurobiological evidence that
the human brain may be viewed as a ``statistical organ'' aiming to
...
Both model the consequences of action.
