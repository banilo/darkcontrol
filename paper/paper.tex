...
%
The main purpose of the DMN, we argue,
may be to perform optimization based on Markov Decision Processes
through vicarious trial and error.
%
Our formal account of DMN function naturally accommodates as special cases
...
%
Notably, our account does not claim that the brain or neural activity in the DMN are completely identical with reinforcement learning algorithms. Rather, we advocate feedback-based learning strategies as an attractive alternative perspective
to understand DMN function.
