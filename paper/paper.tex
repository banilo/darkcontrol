...
In the definition of $G^\pi$ above, the constant $\gamma \in [0, 1]$ is the \textit{discount factor}.
...
as implemented in the DMN. For there to be any learning at all, it is thus necessary that $\gamma > 0$.
