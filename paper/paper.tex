...
functional account that was proposed for the DMN \cite{gusnard2001medial}.
Since then,
different investigators have speculated that neural activity in the DMN
may reflects the brain’s relentless tracking of
relevance in the environment
as an advantageous evolutionary adaptation
\cite{}.
-> the most behaviorally relevant stimuli
-> particularly in the secur- ing of mates, protection, and resources
-> tracking for salient and unexpected events

This coherent neurobiological network would be prominently engaged as a “radar” as well as in self-relevant information processing
...
social systems to solve ecological problems in a social way
\cite{whiten1988machiavellian}.
...
Being able to detect the intention and upcoming actions of conspecific
turned into a decisive evolutionary advantage.

-> contents of memory and everyday dreaming tied to people and relationships to them
...
role increasing during self-referential tasks.


 \begin{itemize}
    \item DMN does social cognition -> but it exists in rats
    and monkeys with much more poorly developped social capacities
    ...
    \item How can a same neurobiological circuit be equally important for baseline house-keeping functions and specific task performance? Yes, if
    environmental relevance is processed, manipulated, and retained
