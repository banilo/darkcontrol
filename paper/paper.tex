...
In the brain, such an experience replay mechanism is probably implemented in the hyppocampus (HC). Indeed, it is well-known that during sleep,
wake, and rest, the hyppocampal activity is positively correlated with activity in stimulus environment, though at a much faster rate.
