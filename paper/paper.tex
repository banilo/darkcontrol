...
According to this model, the environment’s dynamics are fully determined by
its current state.
...
number of past states, it can reformulated as a stan- dard memoryless Markov process by simply expanding the
