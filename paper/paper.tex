...
This computational account of DMN will be described in the mathematical framework of Markov Decision Processes (MDPs). MDPs indeed address specifically the case of decision making in stochastic context with rewards.
