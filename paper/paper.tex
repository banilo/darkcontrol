...
allowing maximization of action outcomes across multiple time-scales.
...
based on stochastic sampling around states and possible transitions \citep{daw2014algorithmic}.
...
\begin{figure}[!h]
  ...
  Overview of how the constituent regions of the DMN (refer to section \ref{sec:nodes}) may
...
%
Ultimately,
neural processes in the DMN may realize a holistic integration
