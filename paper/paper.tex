...
\begin{wrapfigure}{r}{.45\linewidth}
  \caption{\textbf{Reinforcement Learning in a nutshell.} At each step, given the current state of the environment,
    agent takes and action. This generates a reward and an observed state transition of the environment.}  
  \centering
  \includegraphics[width=.9\linewidth]{rl.png}
  \label{fig:rl}
\end{wrapfigure}
