...
\textbf{XXX Elvis: this section needs more tight integration of the parts, and no just a separate independent subsection for each portion of the DMN...}
...
\begin{mdframed}
  ...
  the nucleus accumbens (NAc), which is connected to the vmPFC, is involved in reward evaluation.
\end{mdframed}
...
in brain networks.
\textbf{XXX perhaps add one sentence to rephrase and detail the idea}. \textbf{XXX Elvis: My biology is very poor.
  The idea of the statement was to say where the parameters $\theta^Q$ would ``live'' in the brain.
  Would these be synaptic strengths ? effective functional connectivity ?
If you know this, please could you rephrase ?}
