...
\subsection{DMN, a central piece in planning and decision-making}
...
%
\subsection{The posteriormedial cortex (PMC): high-order integration}
...
the nucleus accumbens (NAc), nvolved in reward evaluation.
...
The gray-matter volume (GMV) of the vmPFC and nucleus accumbens
...
%
The anterior RTPJ (\textbf{XXX ???})  is a key node network is central for
