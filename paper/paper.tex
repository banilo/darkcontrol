...
\textit{environment / world}. In a general RL framework, an \textit{agent}
...
% table.
The celebrated \textit{Bellman's equation} \cite{sutton1998reinforcement} then takes the simple form
\begin{equation}
  \begin{split}
