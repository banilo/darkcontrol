...
\title{The Default Mode Network is a Reinforcement Learning Agent!}
...
Formally, we propose reinforcement learning to be a particularly attractive framework
to describe, quantify, DMN function and the brain.
...
develops an MDP-based Theory of Mind for learning agents (the \textit{ToM-Net}).
