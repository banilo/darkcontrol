...
would correspond to the strengths of low-level synaptic or high-level functional connections between different neurons / nodes
in the network.

Learning of the the entire model parameters can effictively be achieved via \textit{backprop},
wherein prediction errors are propagated from lower to higher regions to modulate the choice of future
