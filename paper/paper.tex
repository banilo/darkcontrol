...
\citep{starkweather2017dopamine,o2006making,o2006making}.
...
``Remarkably, Barto proposes to decouple extrinsic rewards (i.e generated by the external environment) from intrinsic reward (generated from withing the "organism")
...
This adds the capacity for memory, since then, the next state depends not only on the current state but also on a finite number of past states.
