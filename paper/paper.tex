sensory\documentclass[10pt,letterpaper]{article}
...
For instance, temporally induced RTPJ lesion in humans diminished the
...
For instance, LTPJ lesions in humans also entail problems in recognizing
...
% \begin{wrapfigure}{r}{.4\linewidth}
%     \caption{Graphical illustration of the Bellman transform}   
%   \includegraphics[width=.9\linewidth]{bellman.png}
%   \label{fig:rl}
% \end{wrapfigure}
