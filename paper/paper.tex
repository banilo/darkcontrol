...
modify its internal representation $p_G(\z|\x)$ about objects in the world, their interactions and dynamics. The model then allows
...
Thus, the brain is unlikely to implement a variant of the wake-sleep algorithm.
...
for instance by looking for and using the light switch or simply leaving the room.
