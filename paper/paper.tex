...
The HC is long known to be involved in
...
Indeed, place-specific neuronal populations in the HC
spike one after another when an animal is choosing between alternative
paths \citep{johnson2007neural}.
...
to, instead, deal with environmental objects and events.
...
A framework of DMN funtion based on RL
can naturally embed human behavior
in the tension between exploitative action with immediate gains and
explorative action with longer-term reward schedules
\citep{dayan2008decision}.
...
neuron spiking sequences that also occur during specific actions.
