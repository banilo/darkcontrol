...
\subsubsection{Consequences for the DMN function}
...
Following our process model of DMN, several empirical predictions can be drawn.



\textbf{Neural correlates of the Bellman equation in the DMN (Humans)}
