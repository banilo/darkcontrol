...
\subsection{Predictive Coding and Bayesian Brain Hypothesis}
...
around forming meaning associations and abstract analogies between
the currently experienced environment and
...
explicit world knowledge stored in past memories
\cite{bar2009proactive}.
Using these semantic analogies to mentally envision scenarios
would improve optimal behavior in the environment
integrated as new memories for future analogical associations.
...
This accounts further explains the reciprocal relationship
...
%
Closely related to episodic memory, language, problem solving,
planning, others' thoughts, and spatial navigation
...
This view is supported by evidence in animals that
...
\begin{itemize}
  ...
  history.
  \item Both: there is no evidence to indicate that predictions of various
  ...
  \item The semantic hypothesis and MDP expose mechanisms of
  how alternative decisions could be mentally explored.
  \item While mental scene construction entails a distinction between
  environmental perception and internally generated mind-wandering
  \footnote{``A computational model of how such a process might be structured
  ...
  (related to the current action, state and reward) and the later
  ...
  a clear explanation how semantic world knowledge and analogies thereof
  lead to prediction about future actions and states.
  ...
  actually chosen (i.e., the estimated cumulative reward).
  \item In sum, the semantic hypothesis lacks an explicit time and
  incentive model.
\end{itemize}
...
How representations of past and future are integrated into
action choice in the present context.
