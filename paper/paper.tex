...
around forming meaning associations and analogies between
the currently experience and
abstract knowledge derived from past experiences
\cite{bar2007proactive, binder1999conceptual}.
Analogies might naturally tie incoming novel sensory stimuli to
explicit world knowledge extractable from past memories
\cite{bar2009proactive}.
%
These semantic analogies can be used to mentally envision non-existent scenarios
that would improve optimal behavior in the environment
by simulating future analogical associations.
...
\begin{itemize}
  ...
  for scene construction in humans is fragmentary and noisy
  ...
  hypothesis lacks an explicit time and incentive model.
\end{itemize}
...
might implement high-level control of the environment to
optimize the organism's fate by obtaining reward and avoiding pain.
...
%
Viewed as a MDP, behavior unfolds by integrating across past
and future experience to guide action choice in the present context.
This account is more compatible with the DMN's involvement across
autobiographical memory retrieval,
abstract reasoning based on internally generated scenes,
and self-projection into the expected future.
MDPs provide a mathematical formalism how
optimal substructure can be recursively exploited
when contemplating nested decisions.
Algorithmic gains by injecting stochasticity in past
behavior and outcomes may plausibilize why
very accurate memories have been evolutionarily de-selected
...
the behavior of RL systems. This makes the proposed machine-learning
...
describe and discuss neuroscientific studies in DMN research.
%
Ultimately,
the DMN can be viewed as a smoothing kernel extending
from the relatively recent past to the relatively close future
to constantly compute complex gain opportunities in the world.
